...
function preload(){
  ...
  sheikhimage = loadImage("Capture1.png", "Capture3.png" , "Capture4.png")
  ...
  obstacle3 = loadImage("blue.gif");
  obstacle4 = loadImage("red.gif");
...
function setup() {
 ...
 /*trex = createSprite(50,500,20,50);
  ...
  sheikh = createSprite(50,500,20,50);
  sheikh.addImage(sheikhimage)
